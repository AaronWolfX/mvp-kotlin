...
import com.gmail.aaronsmith.mvp_kotlin.MyApplication
import com.gmail.aaronsmith.mvp_kotlin.api.ApiService
import com.gmail.aaronsmith.mvp_kotlin.api.UrlConstant
import com.gmail.aaronsmith.mvp_kotlin.utils.AppUtils
import com.gmail.aaronsmith.mvp_kotlin.utils.NetworkUtil
import com.gmail.aaronsmith.mvp_kotlin.utils.Preference
import okhttp3.*
...
//                .addInterceptor(addCacheInterceptor())
    ...
    private fun addCacheInterceptor(): Interceptor {
        return Interceptor { chain ->
            ...
            if (NetworkUtil.isNetworkAvailable(MyApplication.context)) {
                val maxAge = 0
                // 有网络时 设置缓存超时时间0小时，意思就是不读区缓存数据，只对get有用，post没有缓冲
                response.newBuilder()
